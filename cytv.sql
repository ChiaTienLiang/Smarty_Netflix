...
INSERT INTO `episodes` (`id`, `episode`, `videoId`, `url`) VALUES
(1, '第一話&emsp;ゲーマー兄妹がファンタジー世界を征服するそうです', 1, 'video01.mp4'),
(2, '第二話&emsp;ゲーマー兄妹が獣耳っ子の国に目をつけたようです', 1, 'video01.mp4'),
(3, '第三話&emsp;ゲーマー兄妹の片割れが消えたようですが……？', 1, 'video01.mp4'),
(4, '第一話&emsp;残酷', 2, 'video02.mp4'),
(5, '第二話&emsp;育手・鱗滝左近次', 2, 'video02.mp4'),
(6, '第三話&emsp;錆兎と真菰', 2, 'video02.mp4'),
(7, '第四話&emsp;最終選別', 2, 'video02.mp4'),
(8, '第一話&emsp;「愛してる」と自動手記人形', 3, '#'),
(9, '第二話&emsp;「戻って来ない」', 3, '#'),
(10, '第三話&emsp;「あなたが、良き自動手記人形になりますように」', 3, '#'),
(11, '第一話&emsp;はじめての逆転', 4, 'video04.mp4'),
(12, '第二話&emsp;逆転姉妹 - 1st Trial', 4, 'video04.mp4'),
(13, '第一話&emsp;緑谷出久：オリジン', 5, 'video5.mp4'),
(14, '第二話&emsp;猛れクソナード', 5, 'video5.mp4'),
(15, '第一話&emsp;始まりの終わりと終わりの始まり', 6, '#'),
(16, '第二話&emsp;再会の魔女', 6, '#'),
(17, '第三話&emsp;ゼロから始まる異世界生活', 6, '#'),
(18, '第一話&emsp;終わりと始まり', 7, '#'),
(19, '第二話&emsp;階層守護者', 7, '#'),
(20, '第三話&emsp;カルネ村の戦い', 7, '#'),
(21, '第一話&emsp;葉秋？葉修？', 8, 'video08.mp4'),
(22, '第二話&emsp;網管高手', 8, 'video08.mp4'),
(23, '第三話&emsp;散人就是這麼任性', 8, 'video08.mp4'),
(24, '第四話&emsp;野圖BOSS是用來搶的！', 8, 'video08.mp4'),
(25, '第五話&emsp;一個人的遊戲？', 8, 'video08.mp4'),
(26, '第六話&emsp;劍聖', 8, 'video08.mp4'),
(27, '第七話&emsp;史上最大BOSS', 8, 'video08.mp4'),
(28, '第八話&emsp;年輕的朋友們來相會！', 8, 'video08.mp4'),
(29, '第九話&emsp;全民公敵', 8, 'video08.mp4'),
(30, '第十話&emsp;分析帝 數據黨', 8, 'video08.mp4'),
(31, '第十一話&emsp;用正確的姿勢告訴你什麼叫做兇殘', 8, 'video08.mp4'),
(32, '第十二話&emsp;十年榮耀一如既往', 8, 'video08.mp4'),
(33, '第一話&emsp;暴風竜ヴェルドラ', 9, '#'),
(34, '第二話&emsp;ゴブリンたちとの出会い', 9, '#'),
(35, '第一話&emsp;二千年後の君へ －シガンシナ陥落①－', 10, '#'),
(36, '第一話&emsp;自称霊能力者·霊幻新隆 ～とモブ～', 11, '#'),
(37, '第一話&emsp;森羅 日下部、入隊', 12, '#');
...
CREATE TABLE `member` (
  ...
  `wallet` int(10) UNSIGNED DEFAULT NULL,
...
(1, 'Brad', 'brad1111@gmail.com', '$2y$10$0S4qEUuJK0kslt.wTPyD6ebnFQUZe6MJj5BJRDKZqoP0mzyqwT2vC', 'c5bea9962ccd5d01d99c8ddbd360272562a18eb795fd020f2e16b18548ec5d3c', 1, NULL, 0);
...
ALTER TABLE `shopping`
  ...
  ADD CONSTRAINT `shopping_ibfk_2` FOREIGN KEY (`videoId`) REFERENCES `videos` (`id`);
COMMIT;
